...
- **5pxâ6px**: Standard components - links, small containers
...
- **Section spacing**: Reduces proportionally - generous desktop â compact mobile
...
4. Confirm uppercase labels have wide letter-spacing (1.4pxâ2.4px) - tight uppercase feels wrong here

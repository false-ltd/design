...
- Don't use heavy shadows generously - depth comes from border treatment, not box-shadow. Shadows are reserved for Level 4â5 elevation only
...
- Don't animate aggressively - animations are slow and subtle (25â100s durations for marquee, gentle glow pulses). Fast motion contradicts the "engineering precision" atmosphere
...
7. Keep animations slow and subtle - marquee scrolls at 25â80s, glow pulses gently

...
- Custom serif display + technical mono kickers - the CondÃ©-Nast-meets-engineering-lab voice
...
- **Mono is always uppercase.** Every WiredMono usage carries `text-transform: uppercase` and 0.9â1.2px letter-spacing. Treat lowercase mono as broken - it should not appear on a WIRED page.
...
- Padding: vertical â 12â14px, horizontal â 24px
...
3. _"Build a 'Most Popular' module: full-bleed black ribbon header with WiredMono uppercase label in white, followed by a numbered list (01â05) using 40px WiredDisplay numerals and 17px Apercu 700 headlines, separated by hairline rules."_

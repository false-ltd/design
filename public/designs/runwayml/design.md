...
- **Tight everywhere**: Nearly every size uses line-height 1.0â1.30 - even body text is relatively compressed. This creates a dense, editorial feel.
...
- Apply small border-radius (4â8px) - the design is NOT pill-shaped
...
- Don't use bold (700+) weight - 400â600 is the full range, with 450 as a precision tool

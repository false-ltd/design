...
The signature move is the custom Anthropic Serif typeface - a medium-weight serif with generous proportions that gives every headline the gravitas of a book title. Combined with organic, hand-drawn-feeling illustrations in terracotta (`#c96442`), black, and muted green, the visual language says "thoughtful companion" rather than "powerful tool." The serif headlines breathe at tight-but-comfortable line-heights (1.10â1.30), creating a cadence that feels more like reading an essay than scanning a product page.
...
- **Relaxed body line-height**: Most body text uses 1.60 line-height - significantly more generous than typical tech sites (1.4â1.5). This creates a reading experience closer to a book than a dashboard.

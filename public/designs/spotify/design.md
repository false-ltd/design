...
- Near-black immersive dark theme (`#121212`â`#1f1f1f`) - UI disappears behind content
...
- Pill buttons (500pxâ9999px) and circular controls (50%) - rounded, touch-optimized
...
- **Compact sizing**: The range is 10pxâ24px - narrower than most systems. Spotify's type is compact and functional, designed for scanning playlists, not reading articles.
...
- Use near-black backgrounds (`#121212`â`#1f1f1f`) - depth through shade variation
- Apply Spotify Green (`#1ed760`) only for play controls, active states, and primary CTAs
- Use pill shape (500pxâ9999px) for all buttons - circular (50%) for play controls
- Apply uppercase + wide letter-spacing (1.4pxâ2px) on button labels
- Keep typography compact (10pxâ24px range) - this is an app, not a magazine
...
5. Heavy shadows (0.3â0.5 opacity) for elevation - light shadows are invisible on dark

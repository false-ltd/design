...
- Don't use solid colored backgrounds for buttons - transparency is the system (rgba white at 0.02â0.05)
...
4. Surface elevation via background opacity: `rgba(255,255,255, 0.02 â 0.04 â 0.05)` - never solid backgrounds on dark

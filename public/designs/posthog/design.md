...
- **Display & Body**: `IBM Plex Sans Variable` - variable font (100â700+ weight range). Fallbacks: `IBM Plex Sans, -apple-system, system-ui, Avenir Next, Avenir, Segoe UI, Helvetica Neue, Helvetica, Ubuntu, Roboto, Noto, Arial`
...
- **Bold heading dominance**: Headings use 700â800 weight - PostHog's typography is confident and assertive, not whispery
- **Generous body line-heights**: Body text at 1.50â1.71 line-height creates extremely comfortable reading - the site is content-heavy and optimized for long sessions
...
- **Uppercase as category signal**: Bold uppercase labels (18pxâ20px weight 700) are used for product category headings - a magazine-editorial convention
...
- **Bordered Card**: Warm Parchment (`#fdfdf8`) or white background, 1px `#bfc1b7` border, 4pxâ6px radius - clean and minimal
...
- Keep body text at generous line-heights (1.50â1.71) - the content-heavy site demands readability
...
- Apply large border-radius (12px+) on cards - PostHog uses 4pxâ6px, keeping things tight and functional
...
- Buttons: 4pxâ6px radius with `4pxâ12px` padding - compact but usable

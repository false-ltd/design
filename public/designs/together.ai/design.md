...
- **Pastel Cloud Gradient**: Soft pink â lavender â soft blue gradients in hero illustrations. These appear in abstract, painterly forms - clouds, feathers, flowing shapes - that create visual warmth without literal meaning.
...
- **Tight line-heights throughout**: Even body text uses 1.25â1.30 line-height - tighter than typical, creating a dense, information-rich feel.
...
- Don't use bold (700+) weight - 400â500 is the full range

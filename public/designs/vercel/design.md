...
- **Gallery emptiness**: Massive vertical padding between sections (80pxâ120px+). The white space IS the design - it communicates that Vercel has nothing to prove and nothing to hide.

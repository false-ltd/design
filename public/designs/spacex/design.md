...
- Universal uppercase + positive letter-spacing (0.96pxâ1.17px) - aerospace stencil aesthetic
...
- **Tight line-heights**: 0.94â1.00 across most text - compressed, efficient, mission-critical communication.
...
- Don't use negative letter-spacing - all tracking is positive (0.96pxâ1.17px)

...
- **Dark Primary**: `#242424` (or `#1e1f23`) background, white text, 6â8px radius. Hover: opacity reduction to 0.7. The signature CTA - maximally dark on white
...
- Use Inter for all body text at weight 300â600 - it's the reliable counterpart to Cal Sans's display personality
- Let product screenshots be the visual content - no illustrations, no decorative graphics
- Apply generous section spacing (80pxâ96px) - the breathing room is essential to the premium feel

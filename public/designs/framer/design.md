...
- Pill-shaped buttons (40pxâ100px radius) - no sharp corners on interactive elements
...
- **5pxâ7px**: Small UI elements, image thumbnails - subtly softened
- **8px**: Standard component radius - code blocks, buttons, interactive elements
- **10pxâ12px**: Cards, product screenshots - comfortably rounded
- **15pxâ20px**: Large containers, feature cards - generously rounded
- **30pxâ40px**: Navigation pills, pagination - noticeably rounded
...
- **Section spacing**: Reduces proportionally - 120px desktop â 60px mobile

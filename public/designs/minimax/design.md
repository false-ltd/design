...
What makes MiniMax distinctive is its pill-button geometry (9999px radius) for navigation and primary actions, combined with softer 8pxâ24px radiused cards for product showcases. The product cards themselves are richly colorful - vibrant gradients in pink, purple, orange, and blue - creating a "gallery of AI capabilities" feel. Against the white canvas, these colorful cards pop like app icons on a phone home screen, making each AI model/product feel like a self-contained creative tool.
...
- **Compact hierarchy**: The size scale jumps from 80px display straight to 28â32px section, then 16â20px body - a deliberate compression that keeps the visual hierarchy feeling efficient.
...
- Keep body text at DM Sans weight 400â500 - heavier weights for buttons only
...
- Don't use sharp corners (0â4px radius) on product cards - the rounded aesthetic is core
...
- Don't use weight 700 for headings - 500â600 is the range, 700 is reserved for strong emphasis in body text
...
5. Keep weights moderate (500â600 for headings) - the brand tone is confident but approachable
